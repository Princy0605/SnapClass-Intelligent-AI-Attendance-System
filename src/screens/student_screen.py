...
def student_screen():
    ...
    photo_source=st.camera_input("Put your face in the center")
                ...
                if detected:
                    ...
                    if show_registration:
                        with st.container(border=True):
                            ...
                            new_name=st.text_input("Enter your name",placeholder='E.g. Hamza Rizvi',key="student_name")
