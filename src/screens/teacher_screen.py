...
from src.database.db import check_teacher_exists,create_teacher,teacher_login,get_teacher_subjects,create_subject,get_attendance_for_teacher
...
def teacher_screen_login():
    ...
    with c2:
        if st.button("Go Back to Home", type='secondary', key='loginbackbtn', shortcut="control+backspace"):
            ...
            st.session_state.pop("teacher_login_username", None)
            st.session_state.pop("teacher_login_password", None)

            st.session_state.pop("teacher_register_username", None)
            st.session_state.pop("teacher_register_name", None)
            st.session_state.pop("teacher_register_password", None)
            st.session_state.pop("teacher_register_confirm_password", None)
    ...
    teacher_username=st.text_input("Enter Username", placeholder="Enter username",key="teacher_login_username")
...
def teacher_screen_register():
    ...
    teacher_username=st.text_input("Enter Username", placeholder="Enter username",key="teacher_register_username")
    teacher_name=st.text_input("Enter name", placeholder="Enter name",key="teacher_register_name")
